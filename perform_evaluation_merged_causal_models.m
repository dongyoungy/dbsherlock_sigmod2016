function [confidence fscore] = perform_evaluation_merged_causal_models(num_discrete, diff_threshold, outlier_multiplier, num_train_samples, batch_count)
    ...
    save('evaluation_merged_causal_models', 'confidence');
    timeElapsed = toc
end
